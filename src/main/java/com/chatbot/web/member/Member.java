...
public class Member {
    ...
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) //아예 못가지고 나가게만듬 비번이아니라 유효기간있는 토큰을 보냄
    ...
    @Column(name = "join_way") private String joinWay;
    @CreationTimestamp
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "member", cascade = CascadeType.ALL)//Entity의 역할
